...
local testchr1 = (string.find(CHROM, "1"))
local testchr2 = (string.find(CHROM, "2"))
local testchr3 = (string.find(CHROM, "3"))
local testchr4 = (string.find(CHROM, "4"))
local testchr5 = (string.find(CHROM, "5"))
local testchr6 = (string.find(CHROM, "6"))
local testchr7 = (string.find(CHROM, "7"))
local testchr8 = (string.find(CHROM, "8"))
local testchr9 = (string.find(CHROM, "9"))
local testchr10 = (string.find(CHROM, "10"))
local testchr11 = (string.find(CHROM, "11"))
local testchr12 = (string.find(CHROM, "12"))
local testchr13 = (string.find(CHROM, "13"))
local testchr14 = (string.find(CHROM, "14"))
local testchr15 = (string.find(CHROM, "15"))
local testchr16 = (string.find(CHROM, "16"))
local testchr17 = (string.find(CHROM, "17"))
local testchr18 = (string.find(CHROM, "18"))
local testchr19 = (string.find(CHROM, "19"))
local testchr20 = (string.find(CHROM, "20"))
local testchr21 = (string.find(CHROM, "21"))
local testchr22 = (string.find(CHROM, "22"))
local testchrM = (string.find(CHROM, "MT"))
local testchrX = (string.find(CHROM, "X"))
local testchrY = (string.find(CHROM, "Y"))
