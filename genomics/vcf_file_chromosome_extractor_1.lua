-- tested with
--	DNA Land Imputed VCF file (file provided by DNA Land)
--	Full Genomes Corporation Y-Elite gVCF (conversion from BAM done by EVE app on sequencing.com [sam tools])
-- set the input file
...
local testchr1 = (string.gmatch(CHROM, "1"))
local testchr2 = (string.gmatch(CHROM, "2"))
local testchr3 = (string.gmatch(CHROM, "3"))
local testchr4 = (string.gmatch(CHROM, "4"))
local testchr5 = (string.gmatch(CHROM, "5"))
local testchr6 = (string.gmatch(CHROM, "6"))
local testchr7 = (string.gmatch(CHROM, "7"))
local testchr8 = (string.gmatch(CHROM, "8"))
local testchr9 = (string.gmatch(CHROM, "9"))
local testchr10 = (string.gmatch(CHROM, "10"))
local testchr11 = (string.gmatch(CHROM, "11"))
local testchr12 = (string.gmatch(CHROM, "12"))
local testchr13 = (string.gmatch(CHROM, "13"))
local testchr14 = (string.gmatch(CHROM, "14"))
local testchr15 = (string.gmatch(CHROM, "15"))
local testchr16 = (string.gmatch(CHROM, "16"))
local testchr17 = (string.gmatch(CHROM, "17"))
local testchr18 = (string.gmatch(CHROM, "18"))
local testchr19 = (string.gmatch(CHROM, "19"))
local testchr20 = (string.gmatch(CHROM, "20"))
local testchr21 = (string.gmatch(CHROM, "21"))
local testchr22 = (string.gmatch(CHROM, "22"))
local testchrM = (string.gmatch(CHROM, "MT"))
local testchrX = (string.gmatch(CHROM, "X"))
local testchrY = (string.gmatch(CHROM, "Y"))
...
-- extract CHROM specific values to the respective files and write out results
	elseif (testchr1 ~= nil) and (string.len(CHROM) == string.len("1")) then
		print("now reading:"..CHROM.."\t"..POS.."\n")
		m_1 = line.."\n"
		f_1:write(m_1)

	elseif (testchr2 ~= nil) and (string.len(CHROM) == string.len("2")) then
		print("now reading:"..CHROM.."\t"..POS.."\n")
		m_2 = line.."\n"
		f_2:write(m_2)
